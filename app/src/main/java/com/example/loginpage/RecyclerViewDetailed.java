...
public class RecyclerViewDetailed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(RecyclerViewDetailed.this, 1);
        recyclerView.setLayoutManager(gridLayoutManager);
        dataList = new ArrayList<>();
        androidData = new DataClass("Camera", R.string.camera, "Java", R.drawable.camera_detail);
        dataList.add(androidData);
        androidData = new DataClass("RecyclerView", R.string.recyclerview, "Kotlin", R.drawable.time_detail);
        dataList.add(androidData);
        ...
        dataList.add(androidData);
        adapter = new MyAdapter(RecyclerViewDetailed.this, dataList);
